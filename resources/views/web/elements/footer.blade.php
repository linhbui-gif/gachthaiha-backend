            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="widget">
                        ...
                        <p class="mb-3">
                            If you are going to use of Lorem Ipsum need to be sure there isn&apos;t anything
                            hidden of text
                        </p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="widget">
                        ...
                        <ul class="widget_instafeed instafeed_col4">
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img1.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img2.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img3.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img4.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img5.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img6.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img7.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('assets/frontend/images/insta_img8.jpg') }}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
