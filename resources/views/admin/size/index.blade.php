    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                {!! Form::hidden('order_by', 'sizes.id', ['id' => 'order_by', 'class' => 'input_order_by']) !!}
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label class="control-label">{{ trans('admin.category_name') }}</label>
...
{{--                            {!! Form::select('category_id', ['' => 'Chọn danh mục'] + $listCategory, old('status'), ['class' => 'form-control select2']) !!}--}}
{{--                        </div>--}}
{{--                    </div>--}}
                </div>
                <div class="row">
