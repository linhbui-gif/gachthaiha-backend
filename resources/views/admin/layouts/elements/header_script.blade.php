...
<link rel="stylesheet" href="{{ asset('assets/admin/plugin/datepicker/datepicker3.css') }}">

<link rel="stylesheet" href="{{ asset('assets/admin/plugin/iCheck/all.css') }}">

<link rel="stylesheet" href="{{ asset('assets/admin/plugin/select2/dist/css/select2.min.css') }}">
