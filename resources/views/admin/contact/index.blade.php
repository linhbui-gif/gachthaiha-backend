    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                {!! Form::hidden('order_by', 'contacts.id', ['id' => 'order_by', 'class' => 'input_order_by']) !!}
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('name', 'Tên Liên hệ', ['class' => 'control-label']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 col-xs-6 text-right">
                        <div class="form-group">
                            <a href="{{ route('admin.contact.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{ trans('admin.add') }}</a>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
