            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            {!! Form::label('image', 'Ảnh danh mục', ['class' => 'control-label']) !!}
                            <span class="text-red" style="font-weight: 600">*</span>
                        ...
                        <div class="form-group">
                            {!! Form::label('is_hot', 'Có phải danh mục hot hiển thị ở trang chủ không?', ['class' => 'control-label']) !!}
                            @php
                                $isHot = array(
                            ...
                            @endphp
                            {!! Form::select('is_hot', ['' => 'Chọn'] + $isHot, old('is_hot'), ['class' => 'form-control select2']) !!}
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            {!! Form::label('description', 'Mô tả danh mục', ['class' => 'control-label']) !!}
                            <span class="text-red" style="font-weight: 600">*</span>
