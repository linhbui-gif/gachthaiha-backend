...
@php
    $pageTitle = !empty($pageTitle) ? $pageTitle : 'Thêm mới trang';
@endphp
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            {!! Form::label('name', 'Tiêu đề trang', ['class' => 'control-label']) !!} <span
                                    class="text-red" style="font-weight: 600">*</span>
                            {!! Form::text('name', old('name'), ['class' => 'form-control generate_alias',
                            'data-render' => 'render_link', 'placeholder' => 'Tiêu đề trang' ]) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('description', old('description'), ['class' => 'form-control', 'rows' => 5, 'id' => 'description', 'placeholder' => 'Mô tả ngắn']) !!}
                        </div>
                ...
                {{--{!! \App\Libs\SeoLib::adminSEOBox(\App\Models\Page::class, !empty($seo) ? $seo : '') !!}--}}
            </div>
