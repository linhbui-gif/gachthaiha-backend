    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                {!! Form::hidden('order_by', 'news_categories.id', ['id' => 'order_by', 'class' => 'input_order_by']) !!}
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('parent_id', 'Cấp cha', ['class' => 'control-label']) !!}
                            @php
                                $listParent = !empty($listParent) ? $listParent : [];
                            @endphp
                            {!! Form::select('parent_id', ['' => 'Chọn cấp cha'] + $listParent, null, ['class' => 'form-control select2']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-9 col-xs-6 text-right">
                        <div class="form-group">
                            <a href="{{ route('admin.news_category.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{ trans('admin.add') }}</a>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
