    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                {!! Form::hidden('order_by', 'news.id', ['id' => 'order_by', 'class' => 'input_order_by']) !!}
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('name', 'Tiêu đề tin', ['class' => 'control-label']) !!}
                            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Tiêu đề tin']) !!}
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 col-xs-6 text-right">
                        <div class="form-group">
                            <a href="{{ route('admin.news.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{ trans('admin.add') }}</a>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
