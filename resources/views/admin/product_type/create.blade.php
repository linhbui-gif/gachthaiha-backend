...
@php
    $pageTitle = !empty($pageTitle) ? $pageTitle : 'Thêm mới loại sản phẩm';
@endphp
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('name', 'Tên loại sản phẩm', ['class' => 'control-label']) !!}
                            <span class="text-red" style="font-weight: 600">*</span>
                            {!! Form::text('name', old('name'), ['class' => 'form-control generate_alias',
                            'data-render' => 'render_link', 'placeholder' => 'Tên loại sản phẩm' ]) !!}
